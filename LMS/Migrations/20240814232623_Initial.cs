        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserLeasingId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookLeases_AspNetUsers_UserLeasingId",
                        column: x => x.UserLeasingId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    BookLeaseId = table.Column<int>(type: "int", nullable: false),
                    UserLeasingId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookReturns_AspNetUsers_UserLeasingId",
                        column: x => x.UserLeasingId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLeases_UserLeasingId",
                table: "BookLeases",
                column: "UserLeasingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookReturns_UserLeasingId",
                table: "BookReturns",
                column: "UserLeasingId");
